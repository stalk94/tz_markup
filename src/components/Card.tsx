...
export default function Card({ item, mod }) {
    if (mod === 'grid') return (
        <div
            className="bg-white shadow-sm rounded p-4 flex flex-col items-stretch"
        >
            <img
                src={item.img}
                alt=""
            ...
            <div className="text-xs flex text-gray-700 mt-2 gap-2">
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col flex-1 text-sm text-gray-700 my-auto">
                ...
                <div className="mt-2">{item.upload}</div>
            </div>
        </div>
    );
}